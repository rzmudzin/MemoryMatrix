...
xcodebuild -project MemoryMatrix.xcodeproj clean archive -scheme "${scheme}" -configuration "${config}" -archivePath "${archivePath}" CODE_SIGN_IDENTITY="26A81253A00C87FE083195619F265D8423F790B7" CODE_SIGN_STYLE=Manual PROVISIONING_PROFILE="${mobileProfile}"
